...
import {
  Database, Download, Table2, Info, ArrowLeft, Upload,
} from 'lucide-react';
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-900 text-gray-100 p-4 rounded-xl font-mono text-sm overflow-x-auto">
                  <p>
                    ...
                    {getBaseUrlClean()}
                    /power-bi/tables/
                    <span className="text-yellow-400">[tableName]</span>
                    /data
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  * Note: The API key is a server-side secret held in the backend environment
                  configuration. Request it from your system administrator — it is deliberately
            ...
            <ol className="list-decimal list-inside text-sm text-gray-700 space-y-3">
              ...
              <li>
                ...
                <code className="bg-gray-100 px-1 rounded">
                  {getBaseUrlClean()}
                  /power-bi/tables/Project/data
                </code>
                ).
              </li>
              <li>
                Under
                <strong>HTTP request header parameters</strong>
                , type
                <code className="bg-gray-100 px-1 rounded">x-api-key</code>
                {' '}
                in the key box and paste the secret API key in the value box.
              </li>
              <li>
                Click
                <strong>OK</strong>
                . Power BI will execute the query and open Power Query Editor.
              </li>
              <li>
                In Power Query Editor, click on the
                <code className="bg-gray-100 px-1 rounded">Record</code>
                {' '}
                or
                <code className="bg-gray-100 px-1 rounded">List</code>
                {' '}
                returned to expand the JSON
                <code className="bg-gray-100 px-1 rounded">data</code>
                {' '}
                array into rows and columns.
              </li>
            </ol>
          </Card>
        </div>
