            ...
            <div className="flex flex-col sm:flex-row items-center justify-between p-4 gap-4 border-t border-gray-100 bg-gray-50 rounded-b-lg">
              <div className="flex flex-wrap items-center gap-4">
                <span className="text-sm text-gray-600">
                  Showing
                  {' '}
                  <span className="font-semibold">{(projectsPage - 1) * projectsLimit + 1}</span>
                  {' '}
                  to
                  {' '}
                  <span className="font-semibold">{Math.min(projectsPage * projectsLimit, projectsMeta.total)}</span>
                  {' '}
                  of
                  {' '}
                  <span className="font-semibold">{projectsMeta.total}</span>
                  {' '}
                  entries
                </span>
