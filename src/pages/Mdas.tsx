...
const Mdas = () => {
    ...
    const { mdas, loading, error, refetch } = useAdmin();
        ...
        },
        {
            ...
            accessor: (item: any) => (
                <Badge variant="neutral">
                    {item.usersCount || 0} user{(item.usersCount !== 1) ? 's' : ''}
                </Badge>
            )
        },
        {
            ...
            accessor: (item: any) => (
                ...
                >
                    {item.projectsYetToBegin || 0} projects
                </button>
            )
        },
        {
            ...
            accessor: (item: any) => (
                ...
                >
                    {item.projectsInProgress || 0} projects
                </button>
            )
        },
        {
            ...
            accessor: (item: any) => (
                ...
                >
                    {item.projectsStalled || 0} projects
                </button>
            )
        },
        {
            ...
            accessor: (item: any) => (
                ...
                >
                    {item.projectsCompleted || 0} projects
                </button>
            )
        }
    ];
