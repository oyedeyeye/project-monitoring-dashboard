            ...
            <div className="flex justify-between items-center border-l-4 border-brand pl-3 mb-4">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Summary KPIs and status distributions for
                  {getPeriodLabel()}
                  {' '}
                  {year}
                </p>
                        ...
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-2 px-3 text-center">
                            <span className="font-semibold text-gray-800">
                              {Math.round(s.avgPhysicalProgress)}
                              %
                            </span>
                          </td>
                        </tr>
                    ...
                    <tbody>
                      {sectorGeographical?.lgas?.map((l: any, idx: number) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-2 px-3 text-center">
                            <span className="font-semibold text-gray-800">
                              {Math.round(l.avgPhysicalProgress)}
                              %
                            </span>
                          </td>
                        </tr>
                    ...
                    <tbody>
                      {sectorGeographical?.districts?.map((d: any, idx: number) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-2 px-3 text-center">
                            <span className="font-semibold text-gray-800">
                              {Math.round(d.avgPhysicalProgress)}
                              %
                            </span>
                          </td>
                        </tr>
                    ...
                    <tbody>
                      {sectorGeographical?.fundingSources?.map((f: any, idx: number) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-2 px-3 text-center">
                            <span className="font-semibold text-gray-800">
                              {Math.round(f.avgPhysicalProgress)}
                              %
                            </span>
                          </td>
                        </tr>
                      ...
                      <tr key={m.mdaId} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4 text-center">
                          <span className="font-bold text-gray-800">
                            {Math.round(m.avgPhysicalProgress)}
                            %
                          </span>
                        </td>
                  ...
                  <div className="space-y-3">
                    {riskBottlenecks?.issueCategories?.map((c: any, idx: number) => (
                      <div key={idx} className="flex justify-between items-center text-sm">
                        ...
                        <span className="bg-red-50 text-red-700 px-2 py-0.5 rounded-lg text-xs font-bold">
                          {c.count}
                          {' '}
                          occurrences
                        </span>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-150 shadow-sm space-y-4">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="font-bold text-gray-800">
                        {Math.round(riskBottlenecks?.meanTimeToResolution || 0)}
                        {' '}
                        days
                      </span>
                    </div>
