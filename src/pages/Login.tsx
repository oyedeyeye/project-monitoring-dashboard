...
function Login() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen relative overflow-hidden font-sans text-dark p-4">
      ...
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-gradient-to-br from-[rgba(255,165,0,0.2)] to-[rgba(255,107,0,0.8)] rounded-bl-full -z-10 top-curve" />
        ...
        <div className="bg-white/90 backdrop-blur-md border border-black/5 rounded-[20px] p-[30px] w-full shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
          <form onSubmit={handleSubmit}>
            ...
            <div className="relative mb-[15px] input-group">
              <i className="fa-solid fa-envelope absolute left-[15px] top-1/2 -translate-y-1/2 text-[#a67c52]" />
              <input
                type="email"
                id="email"
                name="email"
            ...
            <div className="relative mb-[15px] input-group">
              <i className="fa-solid fa-lock absolute left-[15px] top-1/2 -translate-y-1/2 text-[#a67c52]" />
              <input
                type="password"
                id="password"
                name="password"
            ...
            <div className="flex items-center justify-center gap-2 text-[#5d4037] text-[0.85rem]">
              <i className="fa-solid fa-lock text-[#a67c52]" />
