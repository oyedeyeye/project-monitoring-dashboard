        ...
        <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100 flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-700 mt-1 mb-3">
              Download the CSV template. Fill it out with your project details using the exact format:
              {' '}
              <strong>mda, project, budget</strong>
              . The first row for any MDA can be left blank for project and budget to serve as a demarcation header.
            </p>
